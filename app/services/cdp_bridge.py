...
class CdpBridge:
    ...
    def _normalize(ev: dict) -> dict:
        meta = {m.get("key"): m.get("value") for m in ev.get("eventMetadata", []) or []}
        return {
            "ts": ev.get("timestamp") or time.time(),
            "service": ev.get("service"),
            "event": ev.get("eventName"),
            "title": meta.get("Title") or meta.get("title") or meta.get("Notification Title"),
            "body": (meta.get("Body") or meta.get("body") or meta.get("Message")
                     or meta.get("Notification Body")),
            "icon": meta.get("Icon") or meta.get("icon"),
            "url": meta.get("Notification Data") or meta.get("URL") or meta.get("url"),
